...
function changeName() {
    var change_name = document.getElementById("name").value;
    document.getElementById("svgname").innerHTML = change_name;
}

function changeNo() {
    var change_no = document.getElementById("card_number").value;
    document.getElementById("svgnumber").innerHTML = change_no;
}

function changeDate() {
    var change_date = document.getElementById("expirationdate").value;
    document.getElementById("svgexpire").innerHTML = change_date;
}

// Generate Card Numbers
var gen = document.querySelector("#generatecard");
gen.addEventListener("click", function () {
    ...
    var ranElement = arrStr[Math.floor(Math.random() * arrStr.length)];
    document.getElementById("svgnumber").innerHTML = ranElement;
    document.getElementById("card_number").innerHTML = ranElement;
})
